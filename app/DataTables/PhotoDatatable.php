...
class PhotoDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.photos.btn.checkbox')
            ->addColumn('edit', 'admin.photos.btn.edit')
            ->addColumn('delete', 'admin.photos.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    {
        return $this->builder()
                    ->setTableId('photodatatable-table')
