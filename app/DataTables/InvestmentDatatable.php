...
class InvestmentDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.investments.btn.checkbox')
            ->addColumn('edit', 'admin.investments.btn.edit')
            ->addColumn('delete', 'admin.investments.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
     ...
     *
     * @param \App\Model\Investment $model
    ...
    {
        return $this->builder()
                    ->setTableId('investmentdatatable-table')
