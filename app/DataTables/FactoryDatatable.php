...
class FactoryDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.factories.btn.checkbox')
            ->addColumn('edit', 'admin.factories.btn.edit')
            ->addColumn('delete', 'admin.factories.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    {
        return $this->builder()
                    ->setTableId('factorydatatable-table')
