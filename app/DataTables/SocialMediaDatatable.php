...
class SocialMediaDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.social_media.btn.checkbox')
            ->addColumn('edit', 'admin.social_media.btn.edit')
            ->addColumn('delete', 'admin.social_media.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
     ...
     *
     * @param \App\Model\SocialMedia $model
