        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 text-center margin-4-rem-bottom sm-margin-3-rem-bottom">
                <span class="alt-font font-weight-500 text-extra-dark-gray
                            d-block margin-5px-bottom ">تابع أحدث الأخبار والفعاليات </span>
                <h6 class="alt-font font-weight-600 text-extra-dark-gray">المركز الإعلامي</h6>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-8 blog-content padding-50px-right
                ...
                <div class="col-12 blog-post-content bg-white border-all border-color-medium-gray p-0 text-center">
                    ...
                    <div class="blog-text d-inline-block w-100">
                        <div class="content padding-3-rem-all lg-padding-4-half-rem-all
                                    xs-padding-20px-lr xs-padding-40px-tb position-relative mx-auto  lg-w-100">
                            <div class="blog-details-overlap text-small font-weight-500
                                        bg-dark-orange alt-font text-white ">
                                        <a href="blog-classic.html" class="text-white">أحدث التغريدات</a>
                            </div>
